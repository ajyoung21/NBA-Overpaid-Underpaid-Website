...
fig = px.scatter(tens, x=tens['career_WS'], y=tens['career_earnings'], hover_data=['name','draft_year'], height=400, trendline=True)
...
fig.update_layout(
    title="Wins Shares by Salary (Drafted 2010-2018)",
