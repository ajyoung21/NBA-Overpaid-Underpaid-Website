...
fig = px.scatter(aughts, x=aughts['career_WS'], y=aughts['career_earnings'], hover_data=['name','draft_year'], height=500, trendline=True)
...
fig.update_layout(
    title="Win Shares by Salary (Drafted 2000-2009)",
