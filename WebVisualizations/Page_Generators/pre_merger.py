...
fig = px.scatter(pre_merger, x=pre_merger['career_WS'], y=pre_merger['career_earnings'], hover_data=['name','draft_year'], height=400, trendline=True)
...
fig.update_layout(
    title="Wins Shares by Salary Pre-Merger (Drafted Before 1976)",
